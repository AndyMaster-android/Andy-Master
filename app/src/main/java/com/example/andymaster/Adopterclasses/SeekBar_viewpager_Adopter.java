...
public class SeekBar_viewpager_Adopter extends FragmentPagerAdapter {


    public SeekBar_viewpager_Adopter(@NonNull FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getItem(int position) {
        ...
        if (position == 0) {
            return new SeekBar_java();
        }else
            return new SeekBar_xml();
    }
