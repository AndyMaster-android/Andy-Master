...
public class Progress_source_code extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager viewPager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressBar_viewpager_Adopter Adopter = new ProgressBar_viewpager_Adopter(getSupportFragmentManager());
