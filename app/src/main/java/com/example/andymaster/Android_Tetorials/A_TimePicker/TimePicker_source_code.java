...
public class TimePicker_source_code extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Timepicker_Viewpager_Adopter Adopter = new Timepicker_Viewpager_Adopter(getSupportFragmentManager());
