...
import com.example.andymaster.Android_Courses.Ac.native_mcqs;
...
public class Overview_mcqs extends AppCompatActivity {
    ...
    private void goToNextQuestion() {
        ...
        if (currentQuestionIndex < quizQuestions.size()) {
            ...
            Toast.makeText(Overview_mcqs.this, "Quiz completed! Your score is " + score, Toast.LENGTH_SHORT).show();
        }
    }
