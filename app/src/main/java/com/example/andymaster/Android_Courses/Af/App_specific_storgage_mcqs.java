...
public class App_specific_storgage_mcqs extends AppCompatActivity {
    ...
    private void goToNextQuestion() {
        ...
        if (currentQuestionIndex < quizQuestions.size()) {
            ...
            Toast.makeText(App_specific_storgage_mcqs.this, "Quiz completed! Your score is " + score, Toast.LENGTH_SHORT).show();
        }
    }
