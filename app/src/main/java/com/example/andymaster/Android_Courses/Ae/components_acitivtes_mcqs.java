...
public class components_acitivtes_mcqs extends AppCompatActivity {
    ...
    private void goToNextQuestion() {
        ...
        if (currentQuestionIndex < quizQuestions.size()) {
            ...
            Toast.makeText(components_acitivtes_mcqs.this, "Quiz completed! Your score is " + score, Toast.LENGTH_SHORT).show();
        }
    }
