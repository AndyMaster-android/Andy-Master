...
public class content_provider_mcqs extends AppCompatActivity {
    ...
    private void goToNextQuestion() {
        ...
        if (currentQuestionIndex < quizQuestions.size()) {
            ...
            Toast.makeText(content_provider_mcqs.this, "Quiz completed! Your score is " + score, Toast.LENGTH_SHORT).show();
        }
    }
