...
import com.example.andymaster.Android_Courses.Ad.Overview_mcqs;
...
public class Broadcast_receiver_mcqs extends AppCompatActivity {
    ...
    private void goToNextQuestion() {
        ...
        if (currentQuestionIndex < quizQuestions.size()) {
            ...
            Toast.makeText(Broadcast_receiver_mcqs.this, "Quiz completed! Your score is " + score, Toast.LENGTH_SHORT).show();
        }
    }
