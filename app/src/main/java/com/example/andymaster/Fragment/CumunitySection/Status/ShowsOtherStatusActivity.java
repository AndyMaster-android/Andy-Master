...
import com.example.andymaster.Fragment.CumunitySection.Status.Adopter.StatusFlipperAdapter;
import com.example.andymaster.Fragment.CumunitySection.Status.Model.StatusItem;
import com.example.andymaster.Fragment.CumunitySection.Status.Model.Viewed;
...
public class ShowsOtherStatusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shows_other_status);
                ...
                for (int i = 0; i < flipperCount; i++) {
                    ...
                    mAdapterViewFlipper.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
                      ...
                      //      mDate.setText(now);
                            ...
                            mStatusReference.child(id).child("statusItem").child(statusItem.getId())
                                    .child("viewed").orderByKey().startAt(myId).endAt(myId).addListenerForSingleValueEvent(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
